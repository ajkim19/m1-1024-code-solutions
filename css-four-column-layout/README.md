...
For this challenge, you will be using HTML and CSS to build a four column layout from scratch. Your implementation doesn't have to look absolutely identical to the reference image, but get as close as you can. It should be difficult to notice any differences.

Complete `index.html` and `styles.css` to create a page that looks as close to the provided `example.png` as possible.

<p align="middle">
  <img src="assets/four-column-layout.png" alt="four-column-layout">
</p>

## Required Font

You will need to include the "Barlow" font family from [Google Fonts](https://fonts.google.com/) to complete this exercise. It should be used as the `font-family` for all of text in your solution.
